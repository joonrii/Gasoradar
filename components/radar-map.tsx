...
function priceIcon(price: number, selected: boolean, band: PriceBand) {
  return L.divIcon({
    ...
    iconSize: [68, 32], iconAnchor: [34, 16],
  });
}
...
export function RadarMap({ stations, fuel, selectedId, userPosition, focus, onSelect }: {
  stations: Station[]; fuel: FuelKey; selectedId: string | null; userPosition: Point | null; focus: Point | null; onSelect: (station: Station) => void;
}) {
